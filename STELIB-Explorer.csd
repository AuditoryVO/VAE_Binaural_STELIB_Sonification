...
;2023
<Cabbage>
form caption("STELIB Explorer") size(880, 567), colour(30, 60, 80), pluginID("STELIB Explorer")
...
vslider bounds(12, 12, 30, 113), channel("level"), text("Level"), range(0, 1, 0.5, 1, 0.001) 
hslider bounds(738, 532, 122, 29) channel("Send"), text("REV"), range(0, 2, 0.2, 1, 0.001) 
hslider bounds(482, 534, 122, 29) channel("Send2"), text("DLY"), range(0, 2, .5, 1, 0.001) 


vslider bounds(12, 130, 30, 113) channel("LpFrec"), text("LPF"), range(20, 20000, 20000, 0.5, 1) 
vslider bounds(10, 250, 30, 113) channel("HpFrec"), text("HPF")range(20, 20000, 20, 0.5, 1) 
...
;dly
;gaDly 		comb	aFilt, 3.5, 0.3
;aDlyFilt moogladder gaDlyL, 20000, .7
